...
- [x] 1. 共有インフラと環境設定の構築
- [x] 1.1 (P) .env_sample ファイルの更新と環境変数定義
...
- [x] 1.2 (P) 永続化ボリュームの定義と権限設定
  - n8n_data, playwright_data, redis_dataボリュームの定義を整理
  - ユーザーID 1000:1000の権限設定を確認
  - _Requirements: 1.4_

- [x] 2. n8n-main コンテナの設定更新
- [x] 2.1 (P) n8n-main サービスの外部タスクランナーモード設定
...
- [x] 2.2 (P) n8n-main サービスのRedis接続設定確認
  - QUEUE_BULL_REDIS_HOST, PORTを適切に設定
  - Redis TLS設定を無効化
  - _Requirements: 2.2_

- [x] 3. n8n-taskrunner カスタムイメージの作成
- [x] 3.1 (P) PlaywrightベースのTask Runner Dockerfileの更新
